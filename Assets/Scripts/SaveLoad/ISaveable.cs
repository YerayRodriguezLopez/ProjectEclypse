...
/// <see cref="GayManager"/> orchestrates the call order:
...
public interface ISaveable
{
    ...
    /// Called by <see cref="GayManager.SaveGame"/> before serialization.
    /// </summary>
    void OnSave(SaveData data);

    /// <summary>
    /// Read persistent state from <paramref name="data"/> and apply it.
    /// Called by <see cref="GayManager.LoadGame"/> after deserialization.
    /// </summary>
