...
public class DissolveVoronoiControllerVTwo : MonoBehaviour
{
    ...
    private void Awake()
    {
        // Per-instance copy so we never mutate the shared asset
    ...
    {
        _isDissolving = true;
        // Fix #3 — removed SetFloat(DissolveSpeed): shader no longer uses it
    }
